    ...
    <div className='bg-[#000] mt-16 w-full'>
      <div className="typography flex flex-col md:flex-row p-[5%] gap-8 md:gap-0 pb-0 mx-auto">
        ...
        <div className='w-full md:w-1/3'>
          ...
          <div className='flex flex-col flex-grow-0 gap-2 mt-2'>
            <a href='https://attend.tedxcolumbialakeyouth.com' target='_blank' rel='noreferrer' className='!bg-clip-text !bg-gradient-to-r from-purple-400 !to-pink-600 !text-transparent'>Apply Now!</a>
