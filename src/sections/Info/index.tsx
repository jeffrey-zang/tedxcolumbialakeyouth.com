    ...
    <div className='z-40 about mt-[99dvh] bg-gradient-to-b from-black via-darkred to-black' id='info'>
      ...
      <div className='section mt-8 pb-16'>
        ...
        <div className='section-wrapper'>
          ...
          <p>In the spirit of ideas worth spreading, TED has created a program called TED<sup>x</sup>. TED<sup>x</sup> is a program of local, self-organized events that bring people together to share a TED-like e<sup>x</sup>perience. Our event is called TED<sup>x</sup>Columbia Lake Youth, where <sup>x</sup> = independently organized TED event. At TED<sup>x</sup>Columbia Lake Youth, TED Talks video and live speakers will combine to spark deep discussion and connection in a small group. The TED Conference provides general guidance for the TED<sup>x</sup> program, but individual TED<sup>x</sup> events, including ours, are self-organized.</p>
        </div>
      </div>
