...
const Partners = () => {
  return (
    <>
      <div
        className="typography mt-16 flex-col mx-auto scroll-m-28"
        id="partners"
      >
        ...
        <LazyLoadImage
          ...
          src={uw}
          alt="sponsor"
          onClick={() => window.open("https://uwaterloo.ca")}
          effect="blur"
          wrapperClassName="partner-logo p-4 w-3/4 md:!w-1/2 mx-auto !grid place-items-center"
        />
        <LazyLoadImage
          key="-2"
          src={wrdsb}
          alt="sponsor"
          onClick={() => window.open("https://www.wrdsb.ca")}
          effect="blur"
          wrapperClassName="mt-4 partner-logo p-4 w-3/4 md:!w-1/2 mx-auto !grid place-items-center"
        />
        <LazyLoadImage
          key="-4"
          src={swril}
          alt="sponsor"
          onClick={() => window.open("https://www.swril.ca")}
          effect="blur"
          wrapperClassName="mt-4 partner-logo p-4 w-3/4 md:!w-1/2 mx-auto !grid place-items-center"
        />
        <LazyLoadImage
          ...
          src={zehrs}
          alt="sponsor"
          onClick={() => window.open("https://www.zehrs.ca/")}
          effect="blur"
          wrapperClassName="mt-4 partner-logo p-4 w-3/4 md:!w-1/2 mx-auto !grid place-items-center"
        />
        <LazyLoadImage
          ...
          src={ycf}
          alt="sponsor"
          className="partner-logo min-w-0 bg-black"
          onClick={() => window.open("https://youthcreativityfund.ca")}
          effect="blur"
          wrapperClassName="mt-4 partner-logo p-4 w-3/4 md:!w-1/2 mx-auto !grid place-items-center bg-black border-2 border-white"
        />
